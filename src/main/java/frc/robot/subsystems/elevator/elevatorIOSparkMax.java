...
public class elevatorIOSparkMax implements elevatorIO {
  ...
  public void updateInputs(elevatorIOInputs inputs) {
    ...
    inputs.velocityRadsPerSec = Units.rotationsToRadians((leader_encoder.getVelocity() + follower_encoder.getVelocity()) / 2.0 / GEAR_RATIO);
    ...
    public void periodic(){
        ...
        leader.setVoltage(elevatorPID.calculate(getHeight(), setpointState.position)
    ...
    private double getHeight(){
        return Units.rotationsToRadians((leader_encoder.getPosition() + follower_encoder.getPosition()) / 2.0 / GEAR_RATIO);
    }
