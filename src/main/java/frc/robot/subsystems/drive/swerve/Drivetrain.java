...
public class Drivetrain extends SubsystemBase {
    ...
    public class DefaultDrive extends Command {
        ...
        @Override
        public void execute() {
            setSpeeds(new ChassisSpeeds(xSupplier.get() * 4.0, ySupplier.get() * 4.0, omegaSupplier.get() * 4.0));
        }
    }
}
