...
public class TunerConstants {
    ...
    public static final DriveConfig driveConfig =
            DriveConfig.builder()
                .maxLinearVelocity((5800.0 / 60.0) / ((50.0 / 14.0) * (16.0 / 28.0) * (45.0 / 15.0)) * wheelRadius * 2 * Math.PI  / 2.0)
    ...
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of((5800.0 / 60.0) / ((50.0 / 14.0) * (16.0 / 28.0) * (45.0 / 15.0)) * wheelRadius * 2 * Math.PI);

    // public static final double maxVelocity = ((5800.0 / 60.0) / ((50.0 / 14.0) * (16.0 / 28.0) * (45.0 / 15.0)) * wheelRadius * 2 * Math.PI  / 2.0);
    ...
    private static final Slot0Configs driveGains =
        new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0).withKV(12.0 / ((5800.0 / 60.0) / ((50.0 / 13.0) * (16.0 / 28.0) * (45.0 / 15.0)) * 2 * Math.PI) * 2 * Math.PI);
    ...
    private static final double kCoupleRatio = 3.8181818181818183; //????  3.8181818181818183 was initially given
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(  (28.0) / 360.0);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(  (33.0) / 360.0);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(  61.0 / 360.0);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of( -23.5 / 360.0);
