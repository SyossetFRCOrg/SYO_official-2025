...
//     c.addCommands(StowFollow(Location.LEFTFORWARDCORALSTATION, Location.PREL));
//     c.addCommands(AutoAlignL4Score());

//     c.addCommands(IntakeFollow(Location.L, Location.LEFTFORWARDCORALSTATION));
//     // c.addCommands(waitSeconds(1));

//     c.addCommands(StowFollow(Location.LEFTFORWARDCORALSTATION, Location.PREK));
...
//   Command createLeftStartIJKL() {
//     PathPlannerPath firstSegment = loadSegment(Location.LSTART, Location.PREI);

//     preloadTrajectoryClass(firstSegment);
//     SequentialCommandGroup c = new SequentialCommandGroup();
//     c.addCommands(resetPose(firstSegment));

//     c.addCommands(follow(Location.LSTART, Location.PREI));
//     c.addCommands(AutoAlignL4Score());

//     c.addCommands(IntakeFollow(Location.I, Location.LEFTFORWARDCORALSTATION));
//     c.addCommands(waitSeconds(1));

//     c.addCommands(StowFollow(Location.LEFTFORWARDCORALSTATION, Location.PREJ));
//     c.addCommands(AutoAlignL4Score());
...
//   Command createLeftStartJIKL() {
//     PathPlannerPath firstSegment = loadSegment(Location.LSTART, Location.PREJ);

//     preloadTrajectoryClass(firstSegment);
//     SequentialCommandGroup c = new SequentialCommandGroup();
//     c.addCommands(resetPose(firstSegment));

//     c.addCommands(follow(Location.LSTART, Location.PREJ));
//     c.addCommands(AutoAlignL4Score());

//     c.addCommands(IntakeFollow(Location.J, Location.LEFTFORWARDCORALSTATION));
//     c.addCommands(waitSeconds(.4));

//     c.addCommands(StowFollow(Location.LEFTFORWARDCORALSTATION, Location.PREI));
//     c.addCommands(AutoAlignL4Score());
