...
public class AutoChooser extends SendableChooser<Auto> {
    private static final List<AutoProgram> AUTO_PROGRAMS = List.of(
            ...
            new AutoProgram(Auto.ONETOTHREETOC, "ONE TO THREE TO C", AutoFactory::createOneToThreeToC),
            new AutoProgram(Auto.THREETOONETOA, "THREE TO ONE TO A", AutoFactory::createThreeToOneToA),
