...
public class AutoSelector extends VirtualSubsystem {
  ...
  public static enum AutoQuestionResponse {
    ...
    //scoring positions (on the reef)
    A,B,C,D,E,F,G,H,I,J,K,L,
    //heights on the reef to score on
    L1,L2,L3,L4,
    
    //where to get coral from
    LEFT_BACK_CORALSTATION,
    LEFT_FORWARD_CORALSTATION,
    RIGHT_BACK_CORALSTATION,
    RIGHT_FORWARD_CORALSTATION,
